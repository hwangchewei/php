                        ...
                        <div class="rd-navbar-main-element">
                            <div class="rd-navbar-nav-wrap">
                                ...
                                <ul class="rd-navbar-nav">
                                    <li class="rd-nav-item"><a class="rd-nav-link" href="index.html">回首頁</a>
                                    </li>
        ...
        <div id="login" class="page-content card card-block p-3 p-sm-4 col-md-6 col-md-offset-3">
            <form class="needs-validation " method="post" novalidate>
                <div class="form-group">
                    <label class="font-weight-bolder">標題</label>
                    <input type="email" class="form-control" name = 'input' id="user_email" aria-describedby="emailHelp" required >
                    
                    <div class="invalid-feedback">Please Enter your Account Name.</div>
                    <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                </div>
                <div class="form-group font-weight-bolder">
                    <label for="user_password" class="font-weight-bolder">文章內容</label>
                    <textarea class="form-control" rows="3" name="input2"></textarea>
                    <div class="invalid-feedback">請輸入文章</div>
                    ...
                    {
                        $title = $_POST['input'];
                        $content = $_POST['input2'];
                        $sql="insert into work_news(news_subject , news_content) value('$title','$content')";
                ...
                <br>
                <input type="submit" name="submit" class="btn btn-primary mb-3" value="確認修改">
                <!-- <input type="submit" name="submit" class="btn btn-primary mb-3" value="確認修改"> -->
            </form>
        </div>
    </div>
